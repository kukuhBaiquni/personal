...
const AboutMe = ({ aboutRef }) => (
  <AboutBody ref={aboutRef}>
    ...
    <ParagraphWrapper>
      ...
      <p>Basically I love to playing games, that&apos;s where i come from. Sometimes I sharpen my problem solving skill at <a href={codewars} rel='noreferrer' target='_blank'>Codewars</a>, if you are a programmer you have to try it (I&apos;m not endorsing, but i can say it&apos;s very helpful). I learned python from there.</p>
